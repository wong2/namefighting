...
public class Screen extends Activity
{
	...
	public void onCreat(Bundle savedInstanceState)
	{
		...
		name1MD5 = m.getMD5ofStr(name1);
		name2MD5 = m.getMD5ofStr(name2);
...
*/
 ...
 class ToDoDB extends SQLiteOpenHelper
 {
	...
	{
		String sql = "CREAT TABLE" + TABLE_NAME +" ("
		+FIELD_id + "INTEGER primary key autoincrement," +" " +FIELD_TEXT + " text)";
		db.execSQL(sql);
	...
	{
		String sql = "DROP TABLE IF EXISTES " +TABLE_NAME;
		db.execSQL(sql);
		onCreate(db);
	}
